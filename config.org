...
Use ~pet~ to manage Python environments.
...
(use-package nano-theme
  ...
  ;; CRT phosphorgreen
  (nano-dark-background "#1a1a1a")    ; Very dark gray, almost black
  (nano-dark-foreground "#33ff33")    ; Bright phosphor green
  (nano-dark-highlight "#0f2f0f")     ; Dark green for selection/highlight
  (nano-dark-subtle "#206020")        ; Medium green for secondary elements
  (nano-dark-faded "#2d8c2d")         ; Muted green for less important elements
  (nano-dark-salient "#9E73E7")
  ;; end CRT phosphorgreen
...
(use-package org-modern
  ...
  ;; Set the face attribute for org-ellipsis

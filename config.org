...
To use mixed fonts for better reading experience use the `mixed-pitch` package.

#+begin_src emacs-lisp
;; (use-package mixed-pitch
;;   :hook
;;   (org-mode . mixed-pitch-mode)
;;   (writer-mode . mixed-pitch-mode))
#+end_src
** Doom themes
...
(use-package nano-theme
  ...
  :custom
  (nano-window-divider-show nil)
  :init
  (require 'nano-theme)
  ;; customize font
  ;; (custom-set-faces
   ;; '(nano-mono ((t (:family "Roboto Mono" :height 140)))))
  (nano-mode)
  ...
  ;; (set-face-attribute 'nano-strong nil :weight 'bold)  

  ;; load theme
  (load-theme 'nano t)
  ;; my preference, set the global font size
...
(use-package buffer-box
  ...
  :config
  (setq buffer-box-default-style 'rounded)
  :bind
  ("C-c b" . buffer-box))
#+end_src

...
;; using cask at the moment, need this path injection
...
(use-package jupyter
  :straight (jupyter :type git
                     ...
                     :branch "fix-python-error-location-ansi")
  :defer t
  :custom
...
(use-package nano
  ...
  ;; Ensure org blocks update whenever the theme is set or toggled
...
(recentf-mode 1)
;; patch, somehome nano-defaults did not do these
(tool-bar-mode -1)
(scroll-bar-mode -1)
#+end_src

...
Running ~emacs-plus@30~ ([[https://github.com/d12frosted/homebrew-emacs-plus]]) installed via ~homebrew~.
...
;; call function to setup advice function: de/customize-nano-themes

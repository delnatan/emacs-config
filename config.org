...
(use-package nano-theme
  ...
  ;; Override org faces to support mixed variable/fixed pitch
  ;; while preserving nano-theme's styling (backgrounds, colors, etc.)
  (with-eval-after-load 'org
    ...
    (set-face-attribute 'org-document-title nil :inherit '(nano-strong variable-pitch) :height 1.6)
    (set-face-attribute 'org-level-1 nil :inherit '(nano-strong variable-pitch) :height 1.4)
    (set-face-attribute 'org-level-2 nil :inherit '(nano-strong variable-pitch) :height 1.2)
    (set-face-attribute 'org-level-3 nil :inherit '(nano-strong variable-pitch) :height 1.1)
    (set-face-attribute 'org-level-4 nil :inherit '(nano-strong variable-pitch) :height 1.05)
